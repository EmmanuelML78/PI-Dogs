...
function Home (){
    ...
    const currentDogs = Array.isArray(dogs) && dogs?.slice(indexFirstDog, indexLastDog);
                ...
                <ul className="container1">
                    <li className='content-select'>
                        <select className="selecttt" onChange={e => handleSortByName(e)}>
                            <option value="All"hidden >Orden alfabético</option>
                    ...
                    <li className='content-select'>
                        <select className="selecttt" onChange={e => handleSortByWeight(e)}>
                            <option value="selected" hidden >Peso</option>
                    ...
                    {allTemperaments && allTemperaments.map((temperament, index) => {
                    return (
                    ...
                    <li className='content-select'>
                        <select className="selecttt" onChange={e => handleFilterOrigin(e)}>
                            <option value="all">Origen</option>
                            <option value='api'>API</option>
                            <option value='created'>DB</option>
                        </select>
                    </li>
                    <button className="buttont" onClick={(event) => handleClick(event)}>Reset</button>
                </ul>
