...
const Detail = () => {
  ...
  return (
    <div
      ...
      <Nav />
      <Link to="/home" className={detal.link}>
        <button className={detal.btnBack}>BACK</button>
      </Link>
      <div className={detal.conteiner}>
        ...
        <div className={detal.content}>
          <ul className={detal.ul}>
            ...
            <p className={detal.detailTxt}>
              {" "}
              {dogDetail?.weight?.length > 1
                ? dogDetail?.weight?.join(" - ")
                : dogDetail?.weight?.pop()}{" "}
              kgs
            </p>
            ...
            <li>
              ...
              <p className={detal.detailTxt}>
                {dogDetail?.height?.length > 1
                  ? dogDetail?.height?.join(" - ")
                  : dogDetail?.height?.pop()}{" "}
                cm
              </p>
            </li>
            <li>
              <h3 className={detal.infoTitle}>Años de vida:</h3>
              <p className={detal.detailTxt}>{dogDetail?.life_span}</p>
            </li>
            <li>
              <h3 className={detal.infoTitle2}>Tempetamentos:</h3>
              {dogDetail?.temperaments?.map((item, index) => (
                <p className={detal.detailTxt2} key={index}>
                  {item}
                </p>
              ))}
            </li>
